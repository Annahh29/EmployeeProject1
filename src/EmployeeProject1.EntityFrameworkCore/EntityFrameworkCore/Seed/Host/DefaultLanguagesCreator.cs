...
namespace EmployeeProject1.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly EmployeeProject1DbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = EmployeeProject1Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(EmployeeProject1DbContext context)
        {
            _context = context;
        }
